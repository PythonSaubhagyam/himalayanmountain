          ...
          <Drawer isOpen={isOpen} onClose={onClose} placement="left" finalFocusRef={menuButtonRef}>
            ...
            <DrawerContent>
              ...
              <DrawerHeader as={Flex} justify="center">
                <Link as={ReactRouterLink} to="/">
                  <Image boxSize="120px" objectFit="contain" src="/himalayan_logo.png" alt="SOSE Logo" />
                </Link>
              </DrawerHeader>
          ...
          >
            ...
            >
              <Link
                ...
                as={ReactRouterLink}
                to={"https://www.facebook.com/himalayanmountain.in"}
              >
              ...
              <Link
                ...
                isExternal={true}
                as={ReactRouterLink}
                to={"https://www.instagram.com/himalayanmountain.in/"}
              >
              ...
              <Link
                ...
                isExternal={true}
                as={ReactRouterLink}
                to={"https://www.youtube.com/@himalayanmountaintea"}
              >
            ...
            >
              ...
              <Link
                ...
                as={ReactRouterLink}
                to={
                  "https://play.google.com/store/apps/details?id=com.sose.himalayan.mountain"
                }
              >
