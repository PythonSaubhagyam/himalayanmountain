      ...
      <Container maxW={"container.xl"} mb={4} px={0} centerContent>
        ...
        <VStack maxW={"6xl"} my={8} px={6}>
          <Box color={"text.300"} textAlign={"justify"}>
            ...
            collect on the Suryan Organic website (<b>www.himalayanmountain.in/</b>)
            ...
            Privacy Policy governs only information provided to www.
            himalayanmountain.in. It does not govern any other information or
            ...
            <br />
            In general, you can visit the <b>www.himalayanmountain.in/</b> without
